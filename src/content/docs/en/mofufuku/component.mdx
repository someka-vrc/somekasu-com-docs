...
<Aside>This feature is available only in the PRO edition.</Aside>
<Aside type="caution">This component depends on the NDMF package. Please install it beforehand via VCC/ALCOM. (If Modular Avatar is already installed, NDMF should already be present.)</Aside>
...
7. Check in Play Mode / Upload  
    Enter Play mode to check the appearance. If everything looks correct, upload the avatar.
